...
const les_cookies = getCookie1();

function getCookie1() {
    // What do I have to add here to look only in the "obligations=" cookie? 
    // Because now it searches all the cookies.
    var object_cookie= new Object();
...
if (document.readyState === 'complete' || document.readyState === 'interactive') {
    ...
    function changerLang() {
        ...
        // les_cookies = getCookie1();
        // console.log(les_cookies);
        if(les_cookies["lang"] === "fr"){
    ...
    if(les_cookies["animation"] === "Active"){
        console.log('je passe');
        animeButton.textContent = 'Desactive';
    }else{
        animeButton.textContent = 'Active';        
    }
    function changerAnimation(){
        
        if(les_cookies["animation"] === "Desactive"){
            // if(document.cookie === "lang=fr"){

            document.cookie = "animation=Active; path=/; expires=" + new Date(new Date().getTime() + 3600 * 24 * 365 * 1000).toUTCString();
            // langButton.textContent= langButton.textContent === 'fr' ? 'en' : 'fr';
        
        }
        else{
            document.cookie = "animation=Desactive; path=/; expires=" + new Date(new Date().getTime() + 3600 * 24 * 365 * 1000).toUTCString();
            // langButton.textContent= langButton.textContent === 'en' ? 'fr' : 'en';
        }
